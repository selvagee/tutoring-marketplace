                          ...
                          <DropdownMenuItem className="py-3">
                            <div className="flex items-start w-full">
                              <Avatar className="h-8 w-8 mr-3">
                                <AvatarImage src={`https://api.dicebear.com/7.x/initials/svg?seed=${convo.user?.fullName}`} />
                                <AvatarFallback>{convo.user?.fullName?.substring(0, 2) || "U"}</AvatarFallback>
                              </Avatar>
                              <div className="flex-1 overflow-hidden">
                                <p className="text-sm font-medium">{convo.user?.fullName}</p>
